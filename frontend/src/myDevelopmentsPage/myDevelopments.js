...
import AddDevelopmentForm from '../developmentsPage/addDevelopmentForm'
import UpdateDevelopmentForm from '../developmentsPage/updateDevelopmentForm'
...
class MyDevelopments extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        isLoaded: false,
  ...
  updateData(){
    let url = "/getDevelopmentsByUser?committee=" + this.state.committeeFilter.toString()
    Promise.all([
        this.updateCathData(),
  ...
  resetFilter(){
    this.setState({committeeFilter: 0},
      () => this.updateData());
  }
              ...
              {({
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Row>
                    ...
                    <Form.Group>
                        <Button type="submit" style={{margin: 5, marginTop: 30}}>Найти</Button>
                    </Form.Group>
                    <Form.Group>
                        <Button variant="secondary" style={{margin: 5, marginTop: 30}}
                          onClick={() => this.resetFilter()}>Сбросить</Button>
                    </Form.Group>
                  </Form.Row>
                </Form>
              )}
